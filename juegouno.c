...
void habitacion(void )
{
    ...
    habitaciongo:
    printf("\n\n\n\n");
    pf = fopen("c:Proyecto/Imagen Estaneria Mapa Puerta Cerrada.txt", "r");
    for(i=0;i<1000000;i++)
    {
        fscanf(pf, "%c",&foto2[i]);
        if(foto2[i]=='?')
    ...
    if(strcmp(ans1, r1) == 0)
        ...
        printf("\n\n\n\n\n\n\n");
        pf = fopen("c:Proyecto/Puerta.txt", "r");
        printf("\n\n\n\n");
        for(i=0;i<1000000;i++)
        {
             fscanf(pf, "%c",&foto1[i]);
        ...
        if((r1[0]=='S')&&(r1[1]=='I'))
            ...
            do{
            printf(" \n\n\n\n\n\n\n\n\n\n");
            pf = fopen("c:Proyecto/Puerta Candado Cerrado.txt", "r");
            printf("\n\n\n\n");
            for(i=0;i<1000000;i++)
            {
                fscanf(pf, "%c",&foto1[i]);
            ...
            if(c1==1492)
                ...
                printf(" \n\n\n\n\n\n\n\n\n\n");
                FILE *pf;
                pf = fopen("c:Proyecto/Puerta Candado Abierto.txt", "r");
                printf("\n\n\n\n");
                for(i=0;i<1000000;i++)
                    {
                    fscanf(pf, "%c",&foto1[i]);
                ...
                printf("\n\n");
                delay(3);
                pf = fopen("c:Proyecto/Imagen Estaneria Mapa Puerta Abierta.txt", "r");
                printf("\n\n\n\n");
                for(i=0;i<1000000;i++)
                    {
                    fscanf(pf, "%c",&foto1[i]);
    ...
    if(strcmp(ans3, r1) == 0)
    {
        ...
        delay(1);
        printf("\n\n\n\n\n");
        pf = fopen("c:Proyecto/Mapa Espana.txt", "r");
        printf("\n\n\n\n");
        for(i=0;i<1000000;i++)
        {
            fscanf(pf, "%c",&foto1[i]);
        ...
        delay(3);
        printf("\n\n\n\n\n\n\n\n\n");
        pf = fopen("c:Proyecto/Mapa Espana Andalucia.txt", "r");
        for(i=0;i<1000000;i++)
        {
            fscanf(pf, "%c",&foto1[i]);
            if(foto1[i]=='?')
        ...
        delay(3);
        printf("\n\n\n\n\n\n");
        pf = fopen("c:Proyecto/Mapa Espana Cataluna.txt", "r");
        printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
        for(i=0;i<1000000;i++)
        {
            fscanf(pf, "%c",&foto1[i]);
        ...
        delay(3);
        printf("\n\n\n");
        pf = fopen("c:Proyecto/Mapa Espana Madrid.txt", "r");
        printf("\n\n\n\n");
        for(i=0;i<1000000;i++)
        {
            fscanf(pf, "%c",&foto1[i]);
        ...
        printf("\n\n\n\n");
        delay(3);
        pf = fopen("c:Proyecto/Mapa Espana Valencia.txt", "r");
        printf("\n\n\n\n");
        for(i=0;i<1000000;i++)
        {
            fscanf(pf, "%c",&foto1[i]);
...
void casa(void )
{
    ...
    char foto1[1000000];
    FILE *pf;
    pf = fopen("c:Proyecto/Puerta Entrada.txt", "r");
    printf("\n\n\n\n");
    for(i=0;i<1000000;i++)
    {
    fscanf(pf, "%c",&foto1[i]);
